	...
	if(isset($_GET['add'])){ 
		...
		<form action="users.php?add=1" method="post">
			...
			<div class="form-group col-md-6 text-right" style="margin-top: 25px;">
				...
				<input type="submit" value="Add User" class="btn btn-primary" name="">
			</div>
		</form>
	<?php }else{
...
<table class="table table-bordered table-striped table-condensed">
	<thread><th></th><th>Name</th><th>Email</th><th>Join Date</th><th>Last Login</th><th>Permissions</th></thread>
	<tbody>
